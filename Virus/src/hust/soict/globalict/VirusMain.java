...
//		------------------------------ HIV ------------------------------
		...
		String[] HIV_infect = new String[] {"Body fluids", "Sex", "Mother to child", "Blood"};
		String[] HIV_symptoms = new String[] {"Fever", "Chills", "Rash", "Night sweats"};
		
		HIV hiv = new HIV(HIV_acidnucleic, HIV_capsid, HIV_symptoms, HIV_infect, HIV_envelope, HIV_protease, HIV_integrase, HIV_tat, HIV_overview_img);
...
//		------------------------------ Covid ------------------------------
		...
		String[] covid_infect = new String[] {"Body Fluids", "Air"};
		String[] covid_symptoms = new String[] {"Fever", "Cough", "Tired", "Loss of taste or smell", "Headache", "Shortness of breath"};
		
		Covid19 covid = new Covid19(covid_acid, covid_capsid, covid_symptoms, covid_infect, covid_overview_img, covid_envelope, covid_Mprotein, covid_eprotein, covid_he, covid_spike);
...
//		------------------------------ Herpes ------------------------------
		...
		String[] herpes_infect = new String[] {"Sex", "Body fluids", "Skin-touching", "Oral"};
		String[] herpes_symptoms = new String[] {"Fever", "Swollen lymph nodes", "Body aches and pains", "Unusual tiredness", "Lack of appetite"};

		Herpes herpes = new Herpes(herpes_acid, herpes_capsid, herpes_envelope, herpes_symptoms, herpes_infect, herpes_overview, herpes_tegument, herpes_gB, herpes_gC, herpes_gD, herpes_gHgL);
...
//		------------------------------ Roto ------------------------------
		...
		String[] rota_infect = new String[] {"Fecal-oral route"};
		String[] rota_symptoms = new String[] {"Vomiting", "Diarrhoea", "Fever", "Dry mouth"};

		Rota rota = new Rota(rota_acid, rota_capsid, rota_symptoms, rota_infect, rota_overview, rota_vp1, rota_vp3, rota_vp4);
...
//		------------------------------ Astro ------------------------------
		...
		String[] astro_infect = new String[] {"Water", "Hand-touching", "Oral"};
		String[] astro_symptoms = new String[] {"Diarrhoea", "Vomiting", "Fever", "Abdominal pain"};
		
		Astro astro = new Astro(astro_acid, astro_capsid, astro_symptoms, astro_infect, astro_overview, astro_vp25, astro_vp27);
...
//		------------------------------ Adeno ------------------------------		
		...
		String[] adeno_infect = new String[] {"Water", "Hand-touching", "Oral", "Body fluids", "Air"};
		String[] adeno_symptoms = new String[] {"Runny nose", "Sore throat", "Fever", "Severe cough", "Headache", "Pink eye"};
