...
//		------------------------------ HIV ------------------------------
		...
		HIV hiv = new HIV(HIV_symptoms, HIV_infect, HIV_overview_img, HIV_acidnucleic, HIV_capsid,
...
//		------------------------------ Covid ------------------------------
		...
		Covid19 covid = new Covid19(covid_symptoms, covid_infect, covid_overview_img, covid_acid, covid_capsid,
...
//		------------------------------ Herpes ------------------------------
		...
		Herpes herpes = new Herpes(herpes_symptoms, herpes_infect, herpes_overview, herpes_acid, herpes_capsid,
...
//		------------------------------ Rota ------------------------------
		...
		Rota rota = new Rota(rota_symptoms, rota_infect, rota_overview, rota_acid, rota_capsid, rota_vp1, rota_vp3, rota_vp4);
...
//		------------------------------ Astro ------------------------------
		...
		Astro astro = new Astro(astro_symptoms, astro_infect, astro_overview, astro_acid, astro_capsid, astro_vp25, astro_vp27);
...
//		------------------------------ Adeno ------------------------------		
		...
		Adeno adeno = new Adeno(adeno_symptoms, adeno_infect, adeno_overview, adeno_acid, adeno_capsid, adeno_penton, adeno_fiber, adeno_knob);
		
//		------------------------------ END INIT DATA ------------------------------
		new MainScreen(hiv, covid, herpes, rota, astro, adeno, jFrame);
	}
}
