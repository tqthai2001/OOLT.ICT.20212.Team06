...
public class Herpes extends VirusWithEnvelope{
	...
	public Herpes(Element acid_nucleic, Element capsid, String[] symptoms, String infectingMethod, Image image_overview,  Element envelope, 
			Element tegument, Element gB, Element gC, Element gD, Element gHgL) {
